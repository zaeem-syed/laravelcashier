...
<head>
    ...
    <title>Nadia's Garden Restaurant - Creating memories, one experience at a time</title>
    ...
    <link href="{{asset('assets/nadia/css/style.css')}}" rel="stylesheet">
    <link rel="icon" href="{{asset('assets/nadia/images/favicon.ico')}}">
</head>
<body>
    <div class="container">
        <div class="top-bar">
        ...
        <header>
            <a href="/"><img src="{{asset('assets/nadia/images/logo.png')}}"></a>
            <nav>
                <ul>
                    <li><a href="/">Home</a></li>
        ...
        <main class="page-content">
            ...
            <div class="menu-categories">
                <article>
                    <a href="#"><img src="{{asset('assets/nadia/images/mushrooms.jpg')}}"></a>
                    <h2><a href="#">Starters</a></h2>
                </article>
                <article>
                    <a href="#"><img src="{{asset('assets/nadia/images/salad.jpg')}}"></a>
