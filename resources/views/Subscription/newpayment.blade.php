...
<div class="row">
    <div class="form-group">
        <form id="payment-form" action="/pay" method="post">
            ...
            <button id="Btnsubmit" class="btn btn-success" value="submit">
...
<script>
    const stripe = Stripe("pk_test_51JO0YOGNImmW4HSL1Yrcy3o4YtcswurD9miUXE2UQG8ejlLBYQT4MpO8hhHjwxAPqXPYHibxrEioe7Pj1hcqC1KJ00qSzcBB64");
    let elements;
